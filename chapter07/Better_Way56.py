...
print(columns)
# 단일 코어에서 한 스레드로 실행되는 프로그램의 경우에는 이런 코드가 잘 작동함
# 하지만 프로그램의 요구사항이 바뀌어서 약간의 I/O가 필요하다면? (ex 온라인 게임)

# 해결책은 I/O를 병렬로 수행해서 그리드 크기와 관계없이 각 세대를 대략 100밀리초 안에 계산할 수 있게 만드는 것
